...
class MappingNetwork(nn.Module):
    """
    Modified from https://github.com/huggingface/diffusers/blob/196835695ed6fa3ec53b888088d9d5581e8f8e94/src/diffusers/models/controlnet.py#L66-L108  # noqa
    """
    ...
    def __init__(
        ...
        for i in range(len(block_out_channels) - 1):
            ...
            self.blocks.append(InflatedConv3d(channel_in, channel_out, kernel_size=3, padding=1))
