# Modified from https://github.com/open-mmlab/PIA/blob/main/animatediff/utils/convert_from_ckpt.py and
# https://github.com/guoyww/AnimateDiff/blob/main/animatediff/utils/convert_from_ckpt.py
